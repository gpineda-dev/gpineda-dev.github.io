...
* **The Kernel & Bare Metal:** Writing a full Unix shell in C (handling `fork`, `execve`, file descriptor tables, and trapping `SIGINT` / `SIGCHLD` signals) and hardening our chops on Gentoo Linux under Jérôme Briffaut.
