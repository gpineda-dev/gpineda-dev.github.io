...
* **Le Noyau et la Machine :** Recoder un shell Unix complet en C (gestion des `fork`, `execve`, tables de descripteurs et capture de signaux `SIGINT` / `SIGCHLD`) et se forger le cuir sur des distributions comme Gentoo sous la houlette de Jérôme Briffaut.
